 ...
 * https://bscscan.com/address/0x9E9Bef94795Bfe87a11A0369B4e0c3B60A6FCf2B#code
*/
...
contract MBankToken is ERC20, Ownable {
    ...
    // marketingFee + burnFee + nftLianDividentFee + nftCreationDividentFee + swapAndLiquify(rest)
    // 50 + 219 + 244 + 146 + liquidity = 15%
    // 50 + 219 + 244 + 146 + 341
    ...
    function getReward(address account) public view returns (uint256) {
        ...
        return _balances[account].mul(SPY).mul(block.timestamp.sub(lastUpdateTime[account])).div(10 ** 18);
    }
    ...
    function swapAndDistribute(uint256 amount) private {
        ...
        // liancNftAddress: 0xcfc5da5557c04f0bfe4965e669a923f4509ac4bb  
        ...
        // creationNftAddress : 0x1e32ff3d7e37a3eedfead6525753a909751fff1d 
